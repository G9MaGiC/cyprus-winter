...
**Last updated:** 2026-08-24 · **Target commit:** `ed6de23` (main — PRs #161–#170 merged)
...
| CI on `main` | Quality, Build, Core Funnel Gate, E2E Full, Dependency Security — green on `535a427` (PR #168) |

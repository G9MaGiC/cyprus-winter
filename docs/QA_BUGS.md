...
| ID | Area | Issue | Fix |
|----|------|-------|-----|
| BUG-283 | Docs | Launch docs stale after PR #159; root loading still used `SECTION.py` / `gap-6` | Merged PR #159 @ `3183177` — docs @ `ca84b6d`, root loading `HOME` tokens |
| BUG-282 | Design | Secondary list hubs still used raw `gap-6` on card grids | Merged PR #158 @ `ca84b6d` — `HOME.gridGap` on villages, beaches, secrets, cycling, wine-routes, regions, events, plan quick-start |
...
| BUG-280 | Docs | `LAUNCH_CHECKLIST.md` / `SCORECARD.md` stale after sprint (698 tests, old commit ref) | Updated to 729 tests, 2252 i18n keys; commit refs refreshed through `3183177` |
...
| BUG-333 | i18n | Beta editorial quality — HE broken Latin (קarnaval, הרidge, קפeneion), תוכנית spelling, FR voice polish | `beta-locale-editorial-quality-overrides.json` + patch; expanded editorial maps with soft-gaps keys |
...
### Editorial quality (Aug 27 2026)

Native pass after chrome: Hebrew MT artifacts + Plan terminology (תוכנית); French tagline/blockquote/drive-left polish. EN-identity funnel body was already clear.

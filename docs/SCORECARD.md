...
| **Test & CI** | lint, typecheck, 600+ unit tests, E2E gate, build | `.github/workflows/ci.yml` | **5/5** — 611 unit tests; Core Funnel + E2E Full green on `main`; Actions on Node 20.19.0 |

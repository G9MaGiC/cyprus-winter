...
| **i18n / SEO** | 7 locales validate; scan clean; hreflang for all locales | `npm run i18n:validate`, `npm run i18n:scan --fail`, `npm run build` | **5/5** — 2273 keys × 7; beta chrome/editorial/legal drafts (PRs #179–#185); graduate badge after lawyer review |
...
| PR #186 (this) | Tier-1 book SEO meta de/el/pl + holdouts/docs sync (BUG-337) |

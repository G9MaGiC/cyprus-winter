...
| Menu semantics + hub skip-nav consolidation on `useTrapFocus` — **roles half shipped** (batch 6: all three `role="menu"` sites converted to disclosures); trap consolidation + hub skip-nav still open | AUD-27 | 4 | 5 | 0.9 | 2 | 9.0 |

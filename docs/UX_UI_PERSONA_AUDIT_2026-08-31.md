...
## 0.0 Final state (2026-09-04, after batch 47)
...
Where the branch ended up, 47 batches later (batches 1–46 merged to main in PR #227; batch 47 continues on the restarted branch):

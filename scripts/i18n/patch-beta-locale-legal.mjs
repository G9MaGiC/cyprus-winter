/**
 * Beta legal i18n (fr/he/ro): privacy + terms body (pending lawyer review).
 * Run: node scripts/i18n/patch-beta-locale-legal.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-legal-overrides.json"), "utf8")
);

/**
 * Beta locale plan funnel i18n (fr, he, ro). Run: node scripts/i18n/patch-beta-locale-plan-i18n.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-plan-i18n-overrides.json"), "utf8")
);

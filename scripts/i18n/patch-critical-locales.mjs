/**
 * Critical-path copy for beta locales (he, ro, fr). Run: node scripts/i18n/patch-critical-locales.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "critical-locale-overrides.json"), "utf8")
);

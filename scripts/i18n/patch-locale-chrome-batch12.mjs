/**
 * Chrome batch 12 i18n (fr/he/ro): home hero, meta og alt, misc labels.
 * Run: node scripts/i18n/patch-locale-chrome-batch12.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch12-overrides.json"), "utf8")
);

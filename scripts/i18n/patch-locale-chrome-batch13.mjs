/**
 * Chrome batch 13 i18n (fr/he/ro): final partial-EN cleanup sweep.
 * Run: node scripts/i18n/patch-locale-chrome-batch13.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch13-overrides.json"), "utf8")
);

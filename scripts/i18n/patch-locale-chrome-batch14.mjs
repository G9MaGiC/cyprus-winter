/**
 * Chrome batch 14 i18n (fr/he/ro): RO cognates + selective FR non-cognate forms.
 * Run: node scripts/i18n/patch-locale-chrome-batch14.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch14-overrides.json"), "utf8")
);

/**
 * Chrome batch 15 i18n (ro): district labels + weather/events parity.
 * Run: node scripts/i18n/patch-locale-chrome-batch15.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch15-overrides.json"), "utf8")
);

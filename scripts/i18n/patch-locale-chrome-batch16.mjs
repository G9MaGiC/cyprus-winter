/**
 * Chrome batch 16 i18n (fr): district labels + Troodos weather label.
 * Run: node scripts/i18n/patch-locale-chrome-batch16.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch16-overrides.json"), "utf8")
);

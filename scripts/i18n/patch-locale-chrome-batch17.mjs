/**
 * Chrome batch 17 i18n (he): Hebrew typo fixes from beta sweep QA.
 * Run: node scripts/i18n/patch-locale-chrome-batch17.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch17-overrides.json"), "utf8")
);

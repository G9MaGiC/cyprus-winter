/**
 * Chrome batch 2 i18n (fr/he/ro): onboarding, help, search page, auth login/register.
 * Run: node scripts/i18n/patch-locale-chrome-batch2.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch2-overrides.json"), "utf8")
);

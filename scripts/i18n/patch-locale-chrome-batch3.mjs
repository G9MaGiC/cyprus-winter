/**
 * Chrome batch 3 i18n (fr/he/ro): account, auth forgot/reset, push, auth layout/social.
 * Run: node scripts/i18n/patch-locale-chrome-batch3.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch3-overrides.json"), "utf8")
);

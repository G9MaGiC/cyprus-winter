/**
 * Chrome batch 4 i18n (fr/he/ro): notFound, book pages, events tips, trails.report.
 * Run: node scripts/i18n/patch-locale-chrome-batch4.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch4-overrides.json"), "utf8")
);

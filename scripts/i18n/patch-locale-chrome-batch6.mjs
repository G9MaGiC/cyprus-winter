/**
 * Chrome batch 6 i18n (fr/he/ro): place types, AI chrome, discover/trails maps & footers, events filters.
 * Run: node scripts/i18n/patch-locale-chrome-batch6.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch6-overrides.json"), "utf8")
);

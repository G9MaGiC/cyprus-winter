/**
 * Chrome batch 7 i18n (fr/he/ro): beaches, villages, wineries, cycling official routes hubs.
 * Run: node scripts/i18n/patch-locale-chrome-batch7.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch7-overrides.json"), "utf8")
);

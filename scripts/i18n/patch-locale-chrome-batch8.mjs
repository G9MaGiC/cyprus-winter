/**
 * Chrome batch 8 i18n (fr/he/ro): install, secrets, nature hub pages.
 * Run: node scripts/i18n/patch-locale-chrome-batch8.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch8-overrides.json"), "utf8")
);

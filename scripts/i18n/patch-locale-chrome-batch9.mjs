/**
 * Chrome batch 9 i18n (fr/he/ro): guides directory, weather hub, team page.
 * Run: node scripts/i18n/patch-locale-chrome-batch9.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-chrome-batch9-overrides.json"), "utf8")
);

/**
 * Funnel-path i18n polish (all locales). Run: node scripts/i18n/patch-locale-funnel-polish.mjs
 */
...
const OVERRIDES = JSON.parse(
  fs.readFileSync(path.join(import.meta.dirname, "beta-locale-funnel-polish-overrides.json"), "utf8")
);

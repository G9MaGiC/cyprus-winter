      ...
      <div className={`${LAYOUT.list} mx-auto`}>
        ...
        <div className={`grid sm:grid-cols-2 ${HOME.gridGap}`}>
          <AppLink
            href="/plan"
            prefetch="auto"
            className={`block ${CARD.contentLg} min-h-[120px] ${CARD.base} border-s-4 border-s-terracotta ${CARD.hover} ${CARD.link} group`}
          >
          ...
          <AppLink
            href="/events"
            prefetch="auto"
            className={`block ${CARD.contentLg} min-h-[120px] ${CARD.base} border-s-4 border-s-aegean ${CARD.hover} ${CARD.link} group`}
          >
            <h3 className={`${TYPE.subSectionTitleLg} text-charcoal group-hover:text-terracotta transition-colors`}>
              {t("eventsTitle")}
            </h3>

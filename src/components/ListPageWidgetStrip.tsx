  ...
  return (
    <div className={`mb-4 sm:mb-6 ${className}`}>
      ...
      <div
        className={
          sticky
            ? `sticky top-[calc(3.5rem+env(safe-area-inset-top,0px))] z-10 ${LAYOUT.stickyBarX} pt-2 sm:pt-0 pb-3 sm:pb-4 bg-background/95 backdrop-blur-sm border-b border-sand-200/80`
            : ""
        }
        role="region"

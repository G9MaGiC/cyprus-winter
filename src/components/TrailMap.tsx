          ...
          >
            <Popup>
              <div className="min-w-[180px]">
                ...
                {trail.trailhead && (
                  <p className="text-sm text-muted-ink mb-2">{trail.trailhead}</p>
                )}
                <a
            ...
            <Marker key={i} position={[w.lat, w.lng]} icon={waypointIcon(i + 1)}>
              <Popup>
                <div className="min-w-[200px]">
                  ...
                  {w.km != null && (
                    <p className="text-xs text-muted-ink mb-1">@ {w.km} km</p>
                  )}
                  {w.note && (
                    <p className="text-sm text-muted-ink mb-2">{w.note}</p>
                  )}
                  <a

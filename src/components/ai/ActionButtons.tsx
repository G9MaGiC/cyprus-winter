    ...
    <div className="flex flex-wrap gap-2 mt-2">
      {actions.map((action, i) => (
        <button
          ...
          className="px-3 py-1.5 text-xs font-medium rounded-full bg-terracotta/10 text-terracotta hover:bg-terracotta/20 transition-colors min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terracotta/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          {action.label}
        </button>
      ))}

...
export default function TimelineRow({
    ...
    return (
      <div className="flex gap-4">
        <div className="flex flex-col items-center shrink-0">
          ...
          {showConnector && <span className="w-0.5 h-4 sm:h-6 bg-sand-200/80 mt-2 shrink-0" aria-hidden />}
        </div>
  ...
  return (
    <div ref={isLastAdded ? lastAddedCardRef : undefined} className="flex gap-4">
      <div className="flex flex-col items-center shrink-0">
        <span

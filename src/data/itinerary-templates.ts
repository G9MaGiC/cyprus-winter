...
export const ITINERARY_TEMPLATES: ItineraryTemplateMeta[] = [
  ...
  },
  {
    ...
    description: "Remote weekdays with one easy stop after work; Troodos and Paphos on the weekend—wifi cafés, mild weather",
    duration: 7,
    bestFor: ["Remote workers", "Slow travel", "Weekend hikers"],
    seasonalNote: "Check /weather for your month. Weekend trails before 10am; weekday stops fit after a workday.",
    bookingNote: "Book the Saturday winery slot early; weekdays are quieter.",
    hasWineries: true,
    // AUD-14: weekdays (1–5) keep the "remote weekdays" promise — one nearby,
    // after-work-sized stop each; the two-stop full days live on the weekend.
    days: {
      1: ["cyprus-museum"],
      2: ["larnaca-salt-lake"],
      3: ["governors-beach"],
